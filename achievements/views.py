...
from .serializer import (
    ...
    AchievementUserSerializer,
    UserAchievementsSerializer,
    AchievementUserUpdateSerializer,
)
...
class AchievementUserCreateRetrieveUpdateDestroy(
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        is_user_achievements_exists = user.achievements.filter(
            pk=achievement_id
        ).exists()
